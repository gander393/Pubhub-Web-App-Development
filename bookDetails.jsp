	...
	%>
		...
		<input type="hidden" name="isbn13" value="<%= request.getParameter("isbn13")%>">
		  ...
		  <div class="form-group">
		    <label for="name" class="col-sm-4 control-label">Name</label>
		     <div class="col-sm-5">
		      <input type="text" class="form-control" id="name" name="name" placeholder="Name" required="required" value="${tag.name }" />
		     </div>
		    </div>
		    <div class="form-group">
		     <div class="col-sm-offset-4 col-sm-1">  
		...
		<form action="RemoveTag" method="post" class="form-horizontal">
		 <input type="hidden" name="isbn13" value="<%= request.getParameter("isbn13")%>">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4 col-sm-1">
		      <button type="reset" class="btn btn-info">Remove Tag</button>
		    </div>
		  </div>
		 </form> 
